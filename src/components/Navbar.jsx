...
export default function Navbar() {
  ...
  return (
    ...
    <div>
      ...
      <div className={drawerClicked ? "w-[55%] sm:w-[45%]  md:w-[17%] h-[100%] bg-white fixed top-0 shadow-xl flex flex-col items-center z-40" : "fixed left-[100%]"} onClick={handleDrawerClick}>
