...
export default function MerchantCard({ name, address, id, clientId}) {
  ...
  return (
    <div className="h-[280px] w-[340px] sm:w-[300px] md:w-[360px] lg:w-[380px] rounded-[5px] shadow-my2 mb-6 sm:mb-2">
        ...
        <p className="text-[12px] opacity-[0.5]">{address}</p>
