...
export default function MerchantCard({ name, lineAddress1, lineAddress2, id}) {
  
  const navigate = useNavigate();

  function showMerchantProducts() {
    navigate(`/client/merchantProducts/${id}`);
  }

  return (
    <div className="h-[280px] w-[340px] sm:w-[300px] md:w-[360px] lg:w-[400px] rounded-[5px] shadow-my mb-6 sm:mb-2">
