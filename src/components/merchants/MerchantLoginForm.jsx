    ...
    return (
      <form onSubmit={handleSubmit} className="p-1">
        ...
        <div className="w-full lg:w-[95%] flex flex-col items-center mt-1 mb-3">
          ...
          <p className="text-[9px] lg:text-[12px] mt-1 font-semibold text-center">Vous n’avez pas de compte ?<Link to="/m/register" className="text-[#3C24D1]"> Devenez partenaire  Shoploc</Link></p>
        </div>
      </form>
    )
}
